...
public class ComicAnalyzerTests
{
	...
	public void ComicAnalyzer_Should_Generate_A_List_Of_Reviews()
	{
		...
		{
			"MuddyCritic rated #1 'Numer 1' 14,50",
			"RottenTornadoes rated #1 'Numer 1' 59,93",
	...
	public void ComicAnalyzer_Should_Handle_Weird_Review_Scores()
	{
		...
		var expectedResults = new[]
		{
			"MuddyCritic rated #1 'Numer 1' -12,12",
			"RottenTornadoes rated #1 'Numer 1' 391691234,49",
			"RottenTornadoes rated #2 'Numer 2' 0,00",
			"MuddyCritic rated #2 'Numer 2' 40,30",
			"MuddyCritic rated #2 'Numer 2' 40,30",
			"MuddyCritic rated #2 'Numer 2' 40,30",
			"MuddyCritic rated #2 'Numer 2' 40,30",
